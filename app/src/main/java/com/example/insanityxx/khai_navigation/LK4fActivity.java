...
public class LK4fActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.lk4e);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.lk4f, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intentLoadNewActivity = new Intent(LK4fActivity.this, KhaiActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.e1) {
            Intent intentLoadNewActivity = new Intent(LK4fActivity.this, LK1fActivity.class);
            startActivity(intentLoadNewActivity);
        } else if (id == R.id.e2) {
            Intent intentLoadNewActivity = new Intent(LK4fActivity.this, LK2fActivity.class);
            startActivity(intentLoadNewActivity);
        } else if (id == R.id.e3) {
            Intent intentLoadNewActivity = new Intent(LK4fActivity.this, LK3fActivity.class);
            startActivity(intentLoadNewActivity);
        }
    ...
    public void onClickableAreaTouched(ClickableArea.State item, float positionXOnDrawable, float positionYOnDrawable, float positionXOnScreen, float positionYOnScreen) {
        if (item instanceof StateObjLK4f) {
            Intent intentLoadNewActivity = new Intent(LK4fActivity.this, LK4fActivity.class);
            startActivity(intentLoadNewActivity);
        }
    }
    ...
    private List<ClickableArea> getClickableAreas() {
        ...
        clickableAreas.add(new ClickableArea(1, 1, 1, 1, new StateObjLK4f()));
